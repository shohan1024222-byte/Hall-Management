...
import { MODULAR_DEPRECATION_ARG } from "./common/index.js";
import { deleteApp as deleteAppCompat, getApp as getAppCompat, getApps as getAppsCompat, initializeApp as initializeAppCompat, setLogLevel as setLogLevelCompat, setReactNativeAsyncStorage as setReactNativeAsyncStorageCompat } from "./internal/registry/app.js";
import { setUserLogHandler } from "./internal/logger.js";
import { version as sdkVersion } from "./version.js";
import { getReactNativeModule } from './internal/nativeModule';
import { APP_NATIVE_MODULE } from "./internal/constants.js";
/**
...
export function deleteApp(app) {
  return deleteAppCompat.call(null, app.name, app._nativeInitialized,
 ...
 * @returns Promise<void>
 */
export function registerVersion(_libraryKeyOrName, _version, _variant) {
...
export function getApps() {
  return getAppsCompat.call(null,
  // @ts-expect-error - Extra arg used by deprecation proxy to detect modular calls
  MODULAR_DEPRECATION_ARG);
}
...
export function getApp(name) {
  return getAppCompat.call(null, name,
  // @ts-expect-error - Extra arg used by deprecation proxy to detect modular calls
  MODULAR_DEPRECATION_ARG);
}
...
export function setLogLevel(logLevel) {
  return setLogLevelCompat.call(null, logLevel,
  // @ts-expect-error - Extra arg used by deprecation proxy to detect modular calls
  MODULAR_DEPRECATION_ARG);
}
...
export function setReactNativeAsyncStorage(asyncStorage) {
  return setReactNativeAsyncStorageCompat.call(null, asyncStorage,
  // @ts-expect-error - Extra arg used by deprecation proxy to detect modular calls
  MODULAR_DEPRECATION_ARG);
}
